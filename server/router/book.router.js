...
router.post("/book",uploadImage.single("coverImgUrl"),verifyToken,bookController.createBook)
...
router.put("/book/:_id",uploadImage.single("coverImgUrl"),bookController.updateBook)
